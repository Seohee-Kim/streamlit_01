...
def main():
    ...
    with st.sidebar:
        ...
        st.markdown('더맵은 전사 광고 캠페인 데이터 기반 디지털마케팅 벤치마크 플랫폼입니다')
        st.text('')
    ...
    if menu == menu_names[0]:
        ...
        grouping_columns_options = ['media_name', 'adproduct_name', 'platform_position', 'device', 'bid_type', 'objective', 'buying_type', 'optimization_goal', 'billing_event', 'inds_name']
